...
import { TopUpCheckoutForm } from "../components/TopUpCheckoutForm";
...
export default function Dashboard() {
  ...
  if (dashboardMode === null) {
    return (
      <div className={`${styles.selectionContainer}`} style={{ position: 'relative', minHeight: '100dvh', background: 'var(--background)', display: 'flex', flexDirection: 'column', alignItems: 'center', overflowX: 'hidden' }}>
              ...
              <div className="animate-fade-in" style={{ position: 'absolute', top: '70px', right: '0', background: 'var(--card-bg)', backdropFilter: 'saturate(180%) blur(60px)', WebkitBackdropFilter: 'saturate(180%) blur(60px)', border: '1px solid var(--glass-border)', borderRadius: '32px', padding: '32px', width: '320px', boxShadow: '0 30px 60px rgba(0,0,0,0.2), inset 0 1px 1px rgba(255,255,255,0.2)', zIndex: 20, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                {session?.user?.email === 'miloszmeskisim@gmail.com' && (
                  <button 
                    ...
                    style={{ width: '100%', background: 'linear-gradient(135deg, rgba(234,179,8,0.1), rgba(202,138,4,0.1))', border: '1px solid rgba(234,179,8,0.2)', padding: '12px 24px', borderRadius: '12px', color: '#eab308', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', transition: 'all 0.2s', marginBottom: '8px' }}
                    onMouseEnter={(e) => { e.currentTarget.style.background = 'linear-gradient(135deg, #eab308, #ca8a04)'; e.currentTarget.style.color = 'white'; }}
                    onMouseLeave={(e) => { e.currentTarget.style.background = 'linear-gradient(135deg, rgba(234,179,8,0.1), rgba(202,138,4,0.1))'; e.currentTarget.style.color = '#eab308'; }}
                  >
        ...
        <div className={`animate-fade-in ${styles.moduleSelectionContent}`} style={{ width: '100%', maxWidth: '960px', padding: 'clamp(140px, 18vh, 180px) clamp(16px, 4vw, 32px) clamp(60px, 8vh, 100px)', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxSizing: 'border-box' }}>
          
          {/* Header Section */}
          <div style={{ width: '100%', display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid var(--border)', flexWrap: 'wrap', gap: '12px' }}>
            <div>
              <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--subtext)', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'block', marginBottom: '6px' }}>
                WYBÓR MODUŁU
              </span>
              <h1 style={{ color: 'var(--foreground)', fontWeight: 800, letterSpacing: '-0.03em', fontSize: 'clamp(1.5rem, 3.5vw, 2.4rem)', margin: 0, lineHeight: 1.15 }}>
                Wybierz moduł pracy
              </h1>
            </div>
            ...
            <button 
              ...
              style={{ background: 'transparent', border: 'none', color: '#635BFF', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '6px', transition: 'opacity 0.2s ease', padding: 0, marginTop: '4px' }}
              onMouseEnter={(e) => { e.currentTarget.style.opacity = '0.8'; }}
              onMouseLeave={(e) => { e.currentTarget.style.opacity = '1'; }}
            >
              <HelpCircle size={16} /> Instrukcja obsługi
            </button>
          </div>

          {/* 3 Minimalist Premium Product Cards */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px', width: '100%' }}>

            {/* CARD 1: Agent Pocztowy */}
            <div 
              style={{
            ...
            >
              <div>
                <div style={{ width: '42px', height: '42px', borderRadius: '12px', background: 'rgba(99, 91, 255, 0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                  <Mail size={20} color="#635BFF" />
                </div>

                <h2 style={{ fontSize: '1.2rem', fontWeight: 700, color: 'var(--foreground)', margin: '0 0 8px 0', letterSpacing: '-0.02em' }}>
                  Agent Pocztowy
                </h2>

                <p style={{ color: 'var(--subtext)', fontSize: '0.9rem', lineHeight: 1.55, margin: '0 0 24px 0' }}>
                  Automatyczna obsługa skrzynek e-mail, analiza intencji klientów i generowanie odpowiedzi 24/7.
                </p>
              </div>

              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#635BFF', fontWeight: 700, fontSize: '0.88rem' }}>
                <span>Otwórz moduł</span>
                <ArrowRight size={16} />
              </div>
            </div>

            {/* CARD 2: Agent Strategiczny */}
            <div 
              style={{
                background: 'var(--card-bg)',
                border: '1px solid var(--border)',
            ...
            >
              <div>
                <div style={{ width: '42px', height: '42px', borderRadius: '12px', background: 'rgba(155, 81, 224, 0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                  <Search size={20} color="#9B51E0" />
                </div>
                ...
                <p style={{ color: 'var(--subtext)', fontSize: '0.9rem', lineHeight: 1.55, margin: '0 0 24px 0' }}>
                  Audyt stron internetowych konkurencji z adresu URL i automatyczne tworzenie planów akcji.
                </p>
              </div>

              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#9B51E0', fontWeight: 700, fontSize: '0.88rem' }}>
                <span>Otwórz moduł</span>
                <ArrowRight size={16} />
              </div>
            </div>

            {/* CARD 3: Baza Leadów B2B */}
            <div 
              style={{
                background: 'var(--card-bg)',
                border: '1px solid var(--border)',
            ...
            >
              <div>
                <div style={{ width: '42px', height: '42px', borderRadius: '12px', background: 'rgba(16, 185, 129, 0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
                ...
                <p style={{ color: 'var(--subtext)', fontSize: '0.9rem', lineHeight: 1.55, margin: '0 0 24px 0' }}>
                  Wyszukiwanie dopasowanych firm B2B i natychmiastowe generowanie spersonalizowanych e-maili.
                </p>
              </div>

              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#10B981', fontWeight: 700, fontSize: '0.88rem' }}>
                <span>Otwórz moduł</span>
                <ArrowRight size={16} />
              </div>
            </div>
  ...
  return (
    ...
    <div className={styles.dashboardLayout}>
                    ...
                    return (
                      <div className={styles.accountSectionCard}>
                        ...
                        <div className={styles.limitsGrid} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                          ...
                          {subscriptionData?.subscriptionStatus === 'active' && !isUnlimited && (
                            <button
                              onClick={async (e) => {
                                setIsTopupModalOpen(true);
                                setIsTopupLoading(true);
                                try {
                                  const res = await fetch("/api/stripe/topup", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ amount: 20, credits: 100 }) });
                                  const data = await res.json();
                              ...
                              style={{ marginTop: "12px", background: "rgba(99, 91, 255, 0.1)", color: "#635BFF", border: "1px solid rgba(99, 91, 255, 0.3)", padding: "10px 16px", borderRadius: "12px", fontSize: "0.95rem", fontWeight: 600, cursor: "pointer", transition: "all 0.2s", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}
                              onMouseEnter={(e) => { e.currentTarget.style.background = "#635BFF"; e.currentTarget.style.color = "#fff"; }}
                              onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(99, 91, 255, 0.1)"; e.currentTarget.style.color = "#635BFF"; }}
                            >
                              Dokup 100 Kredytów (20 PLN)
                            </button>
                          )}
                        </div>
                      </div>
      ...
      {isTopupModalOpen && (
        <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "100%", background: "rgba(0,0,0,0.5)", zIndex: 99999, display: "flex", justifyContent: "center", alignItems: "center", padding: "20px" }}>
          <div style={{ background: "#fff", width: "100%", maxWidth: "450px", borderRadius: "16px", padding: "24px", position: "relative" }}>
            <button onClick={() => { setIsTopupModalOpen(false); setTopupClientSecret(null); }} style={{ position: "absolute", top: "16px", right: "16px", background: "none", border: "none", cursor: "pointer", color: "#6b7280" }}>
              <X size={24} />
            </button>
            {isTopupLoading && <div style={{ padding: "40px", textAlign: "center" }}><div className={styles.spinner} style={{ display: "inline-block" }}></div><p style={{marginTop: "12px", color:"#6b7280", fontWeight:500}}>Ładowanie kasy...</p></div>}
            {!isTopupLoading && topupClientSecret && stripePromise && (
              <Elements stripe={stripePromise} options={{ clientSecret: topupClientSecret, appearance: { theme: 'stripe' } }}>
                <TopUpCheckoutForm amountText="100 Kredytów (20,00 zł)" />
              </Elements>
            )}
          </div>
        </div>
