      ...
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          <div className={styles.botAvatar}>
            <img src="/logo.png?v=4" alt="meskiai" style={{ width: '28px', height: '28px', objectFit: 'contain', filter: 'var(--logo-filter)', display: 'block' }} />
          </div>
          <div>
          ...
          messages.map((m) => (
            <div key={m.id} className={`${styles.messageWrapper} ${m.role === 'user' ? styles.messageUser : ''}`}>
              <div className={`${styles.msgAvatar} ${m.role === 'user' ? styles.msgAvatarUser : styles.msgAvatarBot}`}>
                {m.role === 'user'
                  ? <User size={16} />
                  : <img src="/logo.png?v=4" alt="meskiai" style={{ width: '22px', height: '22px', objectFit: 'contain', filter: 'var(--logo-filter)', display: 'block' }} />
                }
              </div>
